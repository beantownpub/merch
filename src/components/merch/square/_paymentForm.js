...
export default class PaymentForm extends Component {
  ...
  componentDidMount(){
    const config = {
      applicationId: "sandbox-sq0idb-joMinPnPEfYAgQPEfc13Cw",
      ...
      callbacks: {
        ...
        createPaymentRequest: () => {
          return {
            ...
            total: {
              label: "MERCHANT NAME",
              amount: `${Math.ceil(this.props.cartTotal * 100)}`,
              pending: false
            },
            lineItems: [
              {
    ...
    console.log(this.props.cartValues)
    console.log(Math.floor(this.props.cartTotal * 100))
    console.log(Math.ceil(this.props.cartTotal * 100))
  }
        ...
        <div className="container">
            <div id="form-container">
                ...
                <button className="button-credit-card"
                        onClick={this.requestCardNonce}>Pay {this.props.cartTotal}</button>
              </div>
