...
const CONTACT_API_PORT = process.env.CONTACT_API_SERVICE_PORT
const MENU_API_HOST = process.env.MENU_API_HOST
const MENU_API_PROTOCOL = process.env.MENU_API_PROTOCOL
const MENU_API_PORT = process.env.MENU_API_SERVICE_PORT
const MERCH_API_HOST = process.env.MERCH_API_HOST
const MERCH_API_PROTOCOL = process.env.MERCH_API_PROTOCOL
